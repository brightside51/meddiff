...
class VQGAN(pl.LightningModule):
    ...
    def forward(self, x, optimizer_idx=None, log_image=False):
        ...
        if optimizer_idx == 0:
            ...
            return recon_loss, x_recon, vq_output, aeloss, gan_feat_loss
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.optimizer_idx == 0:
            ...
            recon_loss, _, vq_output, aeloss, gan_feat_loss = self.forward(x, self.optimizer_idx)
            commitment_loss = vq_output['commitment_loss']
            self.optimizer_idx = 1
            #loss = recon_loss + commitment_loss + aeloss + perceptual_loss + gan_feat_loss
            loss = recon_loss + commitment_loss + aeloss + gan_feat_loss
