...
#SBATCH --output=/nas-ctm01/homes/pfsousa/meddiff/logs/run_Vluna/output.out
#SBATCH --error=/nas-ctm01/homes/pfsousa/meddiff/logs/run_Vluna/error.err
...
#export CUDA_VISIBLE_DEVICES=0   # only if a V100 is available

#module load anaconda3
#module load cuda/11.8
#eval "$(conda shell.bash hook)"
#source /nas-ctm01/homes/pfsousa/.conda/bin/activate meddiff
...
#nvidia-smi
#pip install torch==2.5.1+cu118 torchvision==0.21.0+cu118 torchaudio==2.7.1+cu118 --index-url https://download.pytorch.org/whl/cu118 --no-cache-dir --no-deps
...
/nas-ctm01/homes/pfsousa/.conda/envs/meddiff3/bin/python /nas-ctm01/homes/pfsousa/meddiff/runs/main_Vluna.py
#python main_V0.py
