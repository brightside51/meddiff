...
metabreast_args = data_parser(dataset = 'metabreast', dataV = 'VI', save = True)
dukebreast_args = data_parser(dataset = 'dukebreast', dataV = 'VI', save = True)
run_args = run_parser(model = 'meddiff', runV = 'VI', save = True)
